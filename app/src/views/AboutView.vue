<template>
  <div class="about">
    ...
    <section class="guide1">
      <img class="guide1Image"
        src="https://res.cloudinary.com/dsderm9xw/image/upload/v1622028085/3D%20Illustrations/3d-illustration2_ykuua3.png"
        alt="3d illustration of boy sitting with legs crossed" data-aos="slide-down" data-aos-ease="ease"
    ...
    <section class="guide2">
      <div class="guide2Description" data-aos="slide-down" data-aos-ease="ease" data-aos-duration="1500"
        data-aos-delay="1000">
        <h1>
          Plan your <br />
          day ahead.
      ...
      <img class="guide2Image"
        src="https://res.cloudinary.com/dsderm9xw/image/upload/v1622028057/3D%20Illustrations/3d-illustration1_j06j0a.png"
        alt="3d illustration of boy with laptop sitting" data-aos="slide-up" data-aos-duration="1500" data-aos-ease="ease"
        data-aos-delay="1000" />
    </section>
  </div>
</template>
